...
icon = pygame.image.load('ufo3.png')
...
#    screen.fill(blue)
    ...
    nlable = myfont.render("WELCOME IN MISSION X" + "",1,(255,0,0))
    mlable = myfont.render("START" + "", 2, (255, 0, 0))
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
          end_it = True
        screen.blit(nlable, (200, 200))
        screen.blit(mlable,(300,300))
        pygame.display.flip()
#game loop:
running = True
